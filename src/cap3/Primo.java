...
Encontrar si un numero es primo o no. Se debe hallar un divisor que no sea 1
ni el propio numero.

IN: un entero n
OUT: un booleano, true -> primo

Se agrega un contador de instrucciones con el fin de visualizar el costo segun
