...
public class AListCustom<E> implements List<E> {
    private static final int defaultSize = 10; // Default size
    private final int maxSize;        // Maximum size of list
    private int listSize;       // Current # of list items
    private int curr;           // Position of current element
    final E[] listArray;      // Array holding list elements
    ...
    public E remove() {
        ...
        // Cuando el curr queda sin un elemento viable
        if (listSize == curr) {
            curr--;
        }
        return it;
    ...
    public void moveToEnd() {
        assert listSize > 0: "Empty List";
        curr = listSize - 1;
    } // Set at end

    public void prev() {
        assert curr > 0 : "No previous element";
        curr--;
    }

    public void next() {
        assert curr < listSize: "No next element";
        curr++;
    }
...
// Extra stuff not printed in the book.
    ...
    public String print() {
        return Arrays.toString(this.listArray);
    }
}
