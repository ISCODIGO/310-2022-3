...
public class BSTTest
    ...
    public void testBST2() {
        ...
        assertEquals(D1.find(100), Integer.valueOf(100));
        assertEquals(D1.find(15), Integer.valueOf(15));
        assertEquals(D1.find(70), Integer.valueOf(70));
        assertEquals(D1.remove(15), Integer.valueOf(15));
        assertEquals(D1.size(), 10);
        assertEquals(D1.remove(33), null);
        assertEquals(D1.size(), 10);
        assertEquals(D1.remove(70), Integer.valueOf(70));
